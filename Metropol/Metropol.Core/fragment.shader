...
void main () {
	...
	vec3 light_colour = vec3(1.0); //the colour of the light (yellow)
	...
	float intensity_knob = 0.1;
	vec3 diffuse_contribution = incident_degree * light_colour * intensity_knob; //portion of the light added by diffuse lighting
